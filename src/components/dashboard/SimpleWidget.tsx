...
export const SimpleWidget = ({ title, subTitle, label, icon, href }: Props) => {
  return (
    <div className="bg-white shadow-xl p-3 w-full sm:min-w-[25%] min-w-full  rounded-2xl border-1 border-gray-50 m-2">
      <div className="flex flex-col">
        ...
        <div className="my-3">
          <div className="flex flex-row items-center justify-between space-x-1 px-3">
            {icon}
